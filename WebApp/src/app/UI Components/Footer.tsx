...
export default function Footer() {
  return (
    ...
    viewport={{ once: false }} id="contact" className="bg-gray-800 text-white py-6 mt-10">
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
        <a href="#form" className="text-lg font-bold mb-4 md:mb-0 cursor-pointer">
        <Image
  ...
  />
          ...
          <a href="mailto:BiologyDept@usc.edu.ph" className="flex items-center space-x-2">
            <Mail size={18} />
