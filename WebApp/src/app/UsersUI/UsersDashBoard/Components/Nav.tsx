...
const navigation = [
  ...
  { name: "Inventory", href: "/UsersUI/UsersDashBoard/Features/UserInventory" },
  { name: "Appointment", href: "/UsersUI/UsersDashBoard/Features/UserAppointment" },
]
    ...
    <nav className="sticky top-0 z-50 bg-white shadow-lg mb-1 opacity-90">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          {/* Logo */}
          <Link href="/UsersUI/UsersDashBoard/Features/UserCollection" className="flex items-center space-x-2 flex-shrink-0">
            <Image
            ...
            <div className="relative">
              <button
                ...
                className={`relative px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200 cursor-pointer ${
                  isActive("/UsersUI/UsersDashBoard/Features/UserProfile")
                    ? "text-[#113F67] font-semibold"
                    : "text-[#113F67] hover:text-[#113F67]/70"
                }`}
              >
              ...
              {profileOpen && (
                <div className="absolute right-0 mt-2 w-40 bg-white border rounded-lg shadow-lg py-2 z-50">
                  <Link
                    href="/UsersUI/UsersDashBoard/Features/UserProfile"
